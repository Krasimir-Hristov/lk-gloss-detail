		...
		<section className="relative overflow-hidden px-4 pt-12 pb-20 md:px-16 md:pt-20 md:pb-32">
			<div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
				...
				<div className="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none">
					...
					{/* Floating badge */}
					<div className="absolute -bottom-4 left-1/2 flex w-max -translate-x-1/2 items-center gap-3 rounded-xl border border-[#353534] bg-[#201f1f] px-5 py-3 shadow-xl md:-left-8 md:translate-x-0">
