					...
					<div className="space-y-10 text-sm leading-relaxed text-[#ccc3d9]">
						...
						<article className="rounded-2xl border border-[#4a4456] bg-[#1a1a2e] p-6 shadow-md md:p-8">
							...
							<p className="mt-1">
								...
								werden. Daten aus dem Kontaktformular, dem Buchungssystem und der KI-Bewertung
								dienen ausschließlich der Bearbeitung Ihrer Anfragen und der Ausführung unserer
								Dienstleistungen.
							</p>
						</article>
						...
						<article className="rounded-2xl border border-[#4a4456] bg-[#1a1a2e] p-6 shadow-md md:p-8">
							...
							<p className="mt-2">
								...
								können Ihre personenbezogene Daten in diese Drittstaaten übertragen und dort
						...
						<article className="rounded-2xl border border-[#4a4456] bg-[#1a1a2e] p-6 shadow-md md:p-8">
							...
							<p className="mt-2">
								...
								Buchungssystem vereinbaren, werden Ihre Angaben aus dem jeweiligen Formular
							...
							<ul className="mt-2 list-disc space-y-2 pl-5">
								...
								<li>
									<strong>AI/LLM Processing:</strong> Die Bilddaten werden an die AI API zur Analyse
									übertragen. Die Datenverarbeitung erfolgt unter strikter Einhaltung der
									Sicherheitsrichtlinien.
								</li>
								<li>
									<strong>Rechtsgrundlage:</strong> Die Verarbeitung der Bilddaten zur Bewertung
									Ihres Fahrzeugs erfolgt auf Grundlage Ihrer Einwilligung gemäß Art. 6 Abs. 1 lit.
									a DSGVO.
								</li>
								<li>
									<strong>Speicherdauer:</strong> Die Fotos werden nur so lange wie nötig
									verarbeitet, um den Bericht zu generieren und Ihnen das Ergebnis anzuzeigen.
								</li>
							</ul>
						</article>
						...
						<article className="rounded-2xl border border-[#4a4456] bg-[#1a1a2e] p-6 shadow-md md:p-8">
							...
							<p className="mt-4">
								...
								unter den oben im Abschnitt „Kontakt“ angegebenen Wegen an uns wenden.
							</p>
						</article>
					</div>
				</div>
